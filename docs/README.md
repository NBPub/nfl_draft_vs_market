...
*see [main presentation page](https://nbpub.github.io/nfl_draft_vs_market/) for detailed iDL, EDGE, and Offensive Tackle analysis description and comparison. *
*Information on the page help read the graphs presented below*

 - Example comparison graphs selected for this page
   - [OT vs iOL example](/#ot-vs-iol)
   - [All positions excluding QB and ST](/#overall)
   - [A few more](/#more-comparisons)
     - [Full Analysis Graph Grids](/#full-grids)
	 - [Comparison Graphs Only](/#individual-comparison-graphs)
	 
See [analysis notebook](https://github.com/NBPub/nfl_draft_vs_market/blob/main/Data%20Analysis.ipynb) 
to generate other [comparisons](https://github.com/NBPub/nfl_draft_vs_market/tree/main?tab=readme-ov-file#analysis). 
...
Even more graph collections are linked below.
 ...
 - Other graph collections
   - Position Comparisons
     ...
     - [performance weighted draft surplus](/main/market%20based%20position%20groups/graphs/Draft%20Surplus%20Position%20Comparisons/performance%20weighted%20surplus)
	   - market fits based on max and second contracts
   - Position Specific
